                    ...
                    <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch"
                                ...
                                <div class="menu-inner flex-column collapse" id="kt_aside_menu_collapse_2">
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-3"
                                            href="<?= base_url('dashboards/website-analytics'); ?>">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link py-3"
                                            href="<?= base_url('dashboards/finance-performance'); ?>">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                            ...
                            <div
                                    ...
                                    <div
                                        ...
                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                            ...
                                            <div
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('pages/profile/overview'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('pages/profile/projects'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                        <span class="menu-title">Projects</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('pages/profile/campaigns'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('pages/profile/documents'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('pages/profile/followers'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('pages/profile/activity'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                        ...
                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                            ...
                                            <div
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('pages/blog/blog-home'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('pages/blog/blog-post'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                        ...
                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                            ...
                                            <div
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('pages/pricing/pricing-1'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('pages/pricing/pricing-2'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                        ...
                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                            ...
                                            <div
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('pages/careers/list'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('pages/careers/apply'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                        ...
                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                            ...
                                            <div
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('pages/faq/classic'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('pages/faq/extended'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                ...
                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                    ...
                                    <div
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link py-3"
                                                href="<?= base_url('pages/account/statements'); ?>">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link py-3"
                                                href="<?= base_url('pages/account/refferals'); ?>">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                    ...
                                    <div
                                        ...
                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                            ...
                                            <div
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('authentication/layouts/basic/sign-in'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('authentication/layouts/basic/sign-up'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('authentication/layouts/basic/two-steps'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('authentication/layouts/basic/password-reset'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('authentication/layouts/basic/new-password'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                        ...
                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                            ...
                                            <div
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('authentication/layouts/aside/sign-in'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                        <span class="menu-title">Sign-in</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('authentication/layouts/aside/sign-up'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                        <span class="menu-title">Sign-up</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('authentication/layouts/aside/two-steps'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                        <span class="menu-title">Two-steps</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('authentication/layouts/aside/password-reset'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                        <span class="menu-title">Password Reset</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('authentication/layouts/aside/new-password'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                        <span class="menu-title">New Password</span>
                                        ...
                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                            ...
                                            <div
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('authentication/layouts/dark/sign-in'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                        <span class="menu-title">Sign-in</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('authentication/layouts/dark/sign-up'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                        <span class="menu-title">Sign-up</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('authentication/layouts/dark/two-steps'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                        <span class="menu-title">Two-steps</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('authentication/layouts/dark/password-reset'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                        <span class="menu-title">Password Reset</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('authentication/layouts/drak/new-password'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                        <span class="menu-title">New Password</span>
                                        ...
                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                            ...
                                            <div
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('authentication/extended/two-factor-auth'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('authentication/extended/multi-steps-sign-up'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('authentication/extended/free-trial-sign-up'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('authentication/extended/coming-soon'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('authentication/general/welcome'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('authentication/general/verify'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('authentication/general/password-confirmation'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('authentication/general/deactivation'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('authentication/general/error-404'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('authentication/general/error-500'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                        ...
                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                            ...
                                            <div
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('authentication/email/verify-email'); ?>"
                                                        target="blank">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('authentication/email/invitation'); ?>"
                                                        target="blank">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('authentication/email/password-reset'); ?>"
                                                        target="blank">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('authentication/email/password-change'); ?>"
                                                        target="blank">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                    ...
                                    <div
                                            ...
                                            <div
                                                ...
                                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="<?= base_url('utilities/modals/general/invite-friends'); ?>">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="<?= base_url('utilities/modals/general/view-users'); ?>">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="<?= base_url('utilities/modals/general/upgrade-plan'); ?>">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="<?= base_url('utilities/modals/general/share-earn'); ?>">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                ...
                                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="<?= base_url('utilities/modals/forms/new-target'); ?>">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="<?= base_url('utilities/modals/forms/new-card'); ?>">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="<?= base_url('utilities/modals/forms/new-address'); ?>">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">New
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="<?= base_url('utilities/modals/forms/create-api-key'); ?>">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="<?= base_url('utilities/modals/forms/bidding'); ?>">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">Bidding</span>
                                                ...
                                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="<?= base_url('utilities/modals/wizards/two-factor-auth'); ?>">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="<?= base_url('utilities/modals/wizards/create-app'); ?>">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="<?= base_url('utilities/modals/wizards/create-campaigns'); ?>">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">Create
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="<?= base_url('utilities/modals/wizards/create-account'); ?>">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">Create
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="<?= base_url('utilities/modals/wizards/create-project'); ?>">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">Create
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="<?= base_url('utilities/modals/wizards/offer-a-deal'); ?>">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                ...
                                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="<?= base_url('utilities/modals/search/users'); ?>">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="<?= base_url('utilities/modals/search/select-location'); ?>">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                        ...
                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                            ...
                                            <div
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('utilities/modals/search/horizontal'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('utilities/modals/search/vertical'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('utilities/search/users'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                        <span class="menu-title">Users</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('utilities/search/select-location'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                        ...
                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                            ...
                                            <div
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('utilities/wizards/horizontal'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                        <span class="menu-title">Horizontal</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('utilities/wizards/vertical'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                        <span class="menu-title">Vertical</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('utilities/wizards/two-factor-auth'); ?>l">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                        <span class="menu-title">Two Factor Auth</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('utilities/wizards/create-app'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('utilities/wizards/create-campaign'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('utilities/wizards/create-account'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('utilities/wizards/create-project'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('utilities/wizards/offer-a-deal'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                            ...
                            <div
                                ...
                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                    ...
                                    <div
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link py-3"
                                                href="<?= base_url('apps/projects/my-projects'); ?>">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link py-3"
                                                href="<?= base_url('apps/projects/view-projects'); ?>">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                    ...
                                    <div
                                        ...
                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                            ...
                                            <div
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3" href="<?= base_url('categories'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3" href="<?= base_url('add-category'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3" href="<?= base_url('edit-category'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                        ...
                                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                            ...
                                            <div class="menu-sub menu-sub-accordion">
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('apps/ecommerce/sales/list'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('apps/ecommerce/sales/details'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('apps/ecommerce/sales/add-order'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('apps/ecommerce/sales/edit-order'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                        ...
                                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                            ...
                                            <div class="menu-sub menu-sub-accordion">
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('apps/ecommerce/customers/list'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('apps/ecommerce/customers/details'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                        <span class="menu-title">Customers
                                        ...
                                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                            ...
                                            <div class="menu-sub menu-sub-accordion">
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('apps/ecommerce/reports/view'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('apps/ecommerce/reports/sales'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                        <span class="menu-title">Sales</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('apps/ecommerce/reports/returns'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('apps/ecommerce/reports/orders'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('apps/ecommerce/reports/shipping'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link py-3"
                                                href="<?= base_url('apps/ecommerce/settings'); ?>">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">Settings</span>
                                ...
                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                    ...
                                    <div
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link py-3"
                                                href="<?= base_url('apps/support-center/tickets/overview'); ?>">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">Overview</span>
                                        ...
                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                            ...
                                            <div
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('apps/support-center/tickets/list'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('apps/support-center/tickets/view'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                        ...
                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                            ...
                                            <div
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('apps/support-center/tutorials/list'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('apps/support-center/tutorials/post'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link py-3"
                                                href="<?= base_url('apps/support-center/faq'); ?>">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">FAQ</span>
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link py-3"
                                                href="<?= base_url('apps/support-center/licenses'); ?>">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">Licenses</span>
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link py-3"
                                                href="<?= base_url('apps/support-center/contact'); ?>">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">Contact Us</span>
                                    ...
                                    <div
                                        ...
                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                            ...
                                            <div
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('apps/user-management/users/list'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('apps/user-management/users/view'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                        ...
                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                            ...
                                            <div
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('apps/user-management/roles/list'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('apps/user-management/roles/view'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link py-3"
                                                href="<?= base_url('apps/user-management/permissions'); ?>">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                ...
                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                    ...
                                    <div
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link py-3"
                                                href="<?= base_url('apps/contacts/getting-started'); ?>">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link py-3"
                                                href="<?= base_url('apps/contacts/add-contact'); ?>">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link py-3"
                                                href="<?= base_url('apps/contacts/edit-contact'); ?>">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link py-3"
                                                href="<?= base_url('apps/contacts/view-contact'); ?>">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                ...
                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                    ...
                                    <div
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link py-3"
                                                href="<?= base_url('apps/subscription/getting-started'); ?>">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">Getting Started</span>
                                ...
                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                    ...
                                    <div
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link py-3"
                                                href="<?= base_url('apps/customers/getting-started'); ?>">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">Getting Started</span>
                                    ...
                                    <div
                                        ...
                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                            ...
                                            <div
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('apps/invoices/view/invoice-1'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('apps/invoices/view/invoice-2'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="<?= base_url('apps/invoices/view/invoice-3'); ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                ...
                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                    ...
                                    <div
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link py-3"
                                                href="<?= base_url('apps/file-manager/folders'); ?>">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link py-3"
                                                href="<?= base_url('apps/file-manager/files'); ?>">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">Files</span>
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link py-3"
                                                href="<?= base_url('apps/file-manager/blank'); ?>">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link py-3"
                                                href="<?= base_url('apps/file-manager/settings'); ?>">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">Settings</span>
                            ...
                            <div
                                ...
                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                    ...
                                    <div
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link py-3"
                                                href="<?= base_url('layouts/toolbars/toolbar-1'); ?>">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link py-3"
                                                href="<?= base_url('layouts/toolbars/toolbar-2'); ?>">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link py-3"
                                                href="<?= base_url('layouts/toolbars/toolbar-3'); ?>">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link py-3"
                                                href="<?= base_url('layouts/toolbars/toolbar-4'); ?>">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link py-3"
                                                href="<?= base_url('layouts/toolbars/toolbar-5'); ?>">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link py-3"
                                                href="<?= base_url('layouts/toolbars/no-toolbar'); ?>">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                ...
                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                    ...
                                    <div
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link py-3"
                                                href="<?= base_url('layouts/aside/light-skin'); ?>">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link py-3"
                                                href="<?= base_url('layouts/aside/font-icons'); ?>">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link py-3"
                                                href="<?= base_url('layouts/aside/minimized'); ?>">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link py-3"
                                                href="<?= base_url('layouts/aside/only-header'); ?>">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                        ...
                        <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start"
                            ...
                            <div
                                class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                                <div class="menu-item">
                                    <a class="menu-link py-3" href="<?= base_url('documentation/base/utilities'); ?>"
                                ...
                                <div class="menu-item">
                                    <a class="menu-link py-3" href="<?= base_url('documentation/getting-started'); ?>"
                                ...
                                <div class="menu-item">
                                    <a class="menu-link py-3"
                                        href="<?= base_url('documentation/getting-started/change-log'); ?>">
                                        <span class="menu-icon">
            ...
            <div class="d-flex align-items-stretch flex-shrink-0">
                        ...
                        <div data-kt-search-element="content"
                            ...
                            <form data-kt-search-element="advanced-options-form" class="pt-1 d-none">
                                ...
                                <div class="d-flex justify-content-end">
                                    ...
                                    <a href="<?= base_url('pages/search/horizontal'); ?>"
                ...
                <div class="d-flex align-items-center ms-1 ms-lg-3">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
                        ...
                        <div class="row g-0">
                            <!--begin:Item-->
                            <div class="col-6">
                                <a href="<?= base_url('apps/projects/budget'); ?>"
                            ...
                            <!--begin:Item-->
                            <div class="col-6">
                                <a href="<?= base_url('apps/projects/settings'); ?>"
                            ...
                            <!--begin:Item-->
                            <div class="col-6">
                                <a href="<?= base_url('apps/projects/list'); ?>"
                            ...
                            <!--begin:Item-->
                            <div class="col-6">
                                <a href="<?= base_url('apps/projects/users'); ?>"
                        ...
                        <div class="py-2 text-center border-top">
                            <a href="<?= base_url('apps/projects/activity'); ?>"
                                class="btn btn-color-gray-600 btn-active-color-primary">View All
                                <!--begin::Svg Icon | path: icons/duotune/arrows/arr064.svg-->
                                <span class="svg-icon svg-icon-5">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                ...
                <div class="d-flex align-items-center ms-1 ms-lg-3">
                    ...
                    <a class="btn btn-icon btn-icon-muted btn-active-light btn-active-color-primary w-30px h-30px w-md-40px h-md-40px"
                        href="<?= base_url('documentation/getting-started/dark-mode'); ?>">

        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                <div data-kt-menu-trigger="click"
                    class="menu-item menu-accordion <?= (current_url() == site_url() . '/') ? 'show here' : ''; ?>">
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion <?=
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion <?=
                            ...
                            <div class="menu-sub menu-sub-accordion">
                                <div
                                    class="menu-item <?= (current_url() == site_url() . '/articles') ? 'show here' : ''; ?>">
                                ...
                                <div
                                    class="menu-item <?= (current_url() == site_url() . '/categories') ? 'show here' : ''; ?>">
                                ...
                                <div
                                    class="menu-item <?= (current_url() == site_url() . '/add-article') ? 'show here' : ''; ?>">
                                ...
                                <div
                                    class="menu-item <?= (current_url() == site_url() . '/edit-article') ? 'show here' : ''; ?>">
                                ...
                                <div
                                    class="menu-item <?= (current_url() == site_url() . '/add-category') ? 'show here' : ''; ?>">
                                ...
                                <div
                                    class="menu-item <?= (current_url() == site_url() . '/edit-category') ? 'show here' : ''; ?>">

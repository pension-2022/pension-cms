                                        ...
                                        <div class="mb-10">
                                            ...
                                            <div>
                                                <select class="form-select form-select-solid" data-kt-select2="true"
                                                    ...
                                                    data-dropdown-parent="#kt_menu_624475d364eb7"
                    ...
                    <div id="kt_content_container" class="container-xxl">
                        ...
                        <form id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row"
                            ...
                            <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                                    ...
                                    <div class="card-body text-center pt-0">
                                        ...
                                        <div class="image-input image-input-empty image-input-outline mb-3"
                                            ...
                                            <div class="image-input-wrapper w-150px h-150px"
                                                style="background-image: url(assets/media//stock/ecommerce/78.gif)">
                                            </div>
                                ...
                                <div class="card card-flush py-4">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <!--end::Select2-->
                                        <!--begin::Description-->
                                        <div class="text-muted fs-7">Assign a template from your current theme to define
                                            how a single product is displayed.</div>
                                        <!--end::Description-->
                                    </div>
                                    <!--end::Card body-->
                                </div>
                            ...
                            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                                                    ...
                                                    <table class="table table-row-dashed fs-6 gy-5 my-0"
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="text-gray-600 fw-bolder">I like this design
                                                                </td>
                                                                <td class="text-end">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-gray-600 fw-bolder">Good product for
                                                                    outdoors or indoors</td>
                                                                <td class="text-end">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-gray-600 fw-bolder">Awesome quality with
                                                                    great materials used, but could be more comfortable
                                                                </td>
                                                                <td class="text-end">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-gray-600 fw-bolder">This is the best
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-gray-600 fw-bolder">I thought it was
                                                                    just average, I prefer other brands</td>
                                                                <td class="text-end">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-gray-600 fw-bolder">Beautifully crafted.
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-gray-600 fw-bolder">Awesome value for
                                                                    money. Shipping could be faster tho.</td>
                                                                <td class="text-end">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-gray-600 fw-bolder">Excellent quality, I
                                                                    got it for my son's birthday and he loved it!</td>
                                                                <td class="text-end">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-gray-600 fw-bolder">I got this for
                                                                    Christmas last year, and it's still the best product
                                                                    I've ever used!</td>
                                                                <td class="text-end">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-gray-600 fw-bolder">Was skeptical at
                                                                    first, but after using it for 3 months, I'm hooked!
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-gray-600 fw-bolder">Great product, too
                                                                    bad I missed out on the sale.</td>
                                                                <td class="text-end">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-gray-600 fw-bolder">Got this on sale!
                                                                    Best decision ever!</td>
                                                                <td class="text-end">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-gray-600 fw-bolder">Firesale is on! Buy
                                                                    now! Totally worth it!</td>
                                                                <td class="text-end">
                                ...
                                <div class="d-flex justify-content-end">
                                    <!--begin::Button-->
                                    <a href="<?= base_url('/articles'); ?>" id="kt_ecommerce_add_product_cancel"

                                        ...
                                        <div class="mb-10">
                                            ...
                                            <div>
                                                <select class="form-select form-select-solid" data-kt-select2="true"
                                                    ...
                                                    data-dropdown-parent="#kt_menu_624475d5ba02a"
                    ...
                    <div id="kt_content_container" class="container-xxl">
                        <form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row"
                                    ...
                                    <div class="card-body text-center pt-0">
                                        ...
                                        <div class="image-input image-input-empty image-input-outline mb-3"
                                            ...
                                            <div class="image-input-wrapper w-150px h-150px"
                                                style="background-image: url(assets/media//stock/ecommerce/123.gif)">
                                            </div>
                                ...
                                <div class="card card-flush py-4">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="text-muted fs-7">Assign a template from your current theme to define
                                            how the category products are displayed.</div>
                                        <!--end::Description-->
                                    </div>
                                    <!--end::Card body-->
                                </div>
                            ...
                            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                                                ...
                                                <div class="form-check form-check-custom form-check-solid">
                                                    ...
                                                    <label class="form-check-label"
                                                        ...
                                                        <div class="text-gray-600">Add products to this category one by
                                                            one by manually selecting this category during product
                                                            creation or update.</div>
                                                    </label>
                                                    <!--end::Label-->
                                                </div>
                                                <!--end::Radio-->
                                                        ...
                                                        <div data-repeater-item=""
                                                            ...
                                                            <div class="w-100 w-md-200px">
                                                                <select class="form-select" name="condition_type"
                                                                    ...
                                                                    <option value="tag" selected="selected">Product Tag
                                                                    </option>
                                                            ...
                                                            <div class="w-100 w-md-200px">
                                                                <select class="form-select" name="condition_equals"
                                                                    ...
                                                                    <option></option>
                                                                    <option value="equal" selected="selected">is equal
                                                                        to</option>
                                ...
                                <div class="d-flex justify-content-end">
                                    <!--begin::Button-->
                                    <a href="<?= base_url('/categories'); ?>" id="kt_ecommerce_add_product_cancel"
